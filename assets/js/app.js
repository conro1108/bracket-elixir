...
import {hooks as colocatedHooks} from "phoenix-colocated/bracket"
...
// FocusManager — moves focus to the primary heading when phase changes
Hooks.FocusManager = {
  updated() {
    const heading = this.el.querySelector('[data-focus-target]')
